...
{
	name = "[INS] Discord",
	author = "Neko- (shavit) edited ,Carbonautics",
...
bool LoadConfig(char[] error, int maxlen)
{
	...
	BuildPath(Path_SM, sPath, PLATFORM_MAX_PATH, "configs/chatlogs.cfg");
...
DiscordMessage(const String:strAuthID[], const String:strName[], const String:strMessage[], bool bTeamChat = false)
{
	...
	FormatEx(sFormat, 1024, "{\"username\":\"%s\", \"content\":\"{msg}\"}", "INS#3 Bot Frenzy Chat");
